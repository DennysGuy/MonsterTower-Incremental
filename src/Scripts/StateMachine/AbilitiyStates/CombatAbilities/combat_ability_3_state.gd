class_name CombatAbility3State extends State
...
func enter() -> void:
	...
	AbilityTimers.activate_ability_cooldown("Combat Ability 3")

	var selected_ability : Ability = PlayerStats.get_equipped_ability("Combat Ability 3")
